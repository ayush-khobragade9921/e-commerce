          ...
          <div className='flex flex-col gap-4 my-8'>
              ...
              <div className='flex gap-2'>
                {productData.sizes.map((item,index)=>(
                  <button onClick={()=>setSize(item)} className={`cursor-pointer border py-2 px-4 bg-gray-200 ${item === size ? 'border-orange-500' : ''}`} key={index}>{item}</button>
                ))}
              </div>
          </div>
                  ...
                  <hr className='mt-8 sm:w-4/5 border-gray-200 border' />
                ...
                {/* ------------------Description and Review Srction---------------- */}
