    ...
    <div  className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t border-gray-200 '>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-120'>
        ...
        <div className='flex gap-3'>
              <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Frist name' />
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={()=>navigate('/orders')} className='cursor-pointer bg-black text-white rounded px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
